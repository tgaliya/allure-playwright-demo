...
test('@UpdatedViaFlow VIA Flow Testing from Login till Logout', async ({ page }) => {
  ...
  await expect
    .soft(page)
    .toHaveURL('https://qa-via.outamationlabs.com/via-ui/#/app/admin/client-management/clients');
  ...
  await Promise.all([
    page.waitForURL(
      'https://qa-via.outamationlabs.com/via-ui/#/app/case-management/case-form/referral-info'
    ),
  ...
  await Promise.all([
    page.waitForURL(
      'https://qa-via.outamationlabs.com/via-ui/#/app/case-management/case-form/' +
        CaseNo +
        '/document'
    ),
  ...
  if (blanktrusteeinfotoaster === true) {
    ...
    await page
      .locator("input[formcontrolname='TrusteeAddress1']")
      .type(trusteeinfo[1], { delay: 50 });
    await page
      .locator("input[formcontrolname='TrusteeAddress2']")
      .type(trusteeinfo[2], { delay: 50 });
  ...
  const CaseNumberDetail: any = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(2) > span:nth-child(2)')
    .textContent();
  ...
  const Case_Number = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(1) > span:nth-child(2)')
    .textContent();
  const Law_FirmID = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(2) > span:nth-child(2)')
    .textContent();
  const Borrower_Name = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(3) > span:nth-child(2)')
    .textContent();
  const Loan_Number = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(4) > span:nth-child(2)')
    .textContent();
  const Investor_Type = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(5) > span:nth-child(2)')
    .textContent();
  const Case_Type = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(6) > span:nth-child(2)')
    .textContent();
  const Servicer_Name = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(7) > span:nth-child(2)')
    .textContent();
  const Property_Address = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(8) > span:nth-child(2)')
    .textContent();
  const Property_City = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(9) > span:nth-child(2)')
    .textContent();
  const Property_State = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(10) > span:nth-child(2)')
    .textContent();
  const Property_Zip = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(11) > span:nth-child(2)')
    .textContent();
  const Case_Status = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(12) > span:nth-child(2)')
    .textContent();
  const Workflow_Name = await page
    .locator('#p-panel-2-content > div > div > div:nth-child(13) > span:nth-child(2)')
    .textContent();
  if (
    Case_Number?.match('23-4527') &&
    Law_FirmID?.match(CaseNumberDetail) &&
    Borrower_Name?.match(BorrowerName) &&
    Loan_Number?.match('79845612') &&
    Investor_Type?.match('FHLMC') &&
    Case_Type?.match('Foreclosure') &&
    Servicer_Name?.match('ABC Bank') &&
    Property_Address?.match(FullAddress) &&
    Property_City?.match('Cottonwood') &&
  ...
  const CaseNumberDetail1: any = await page
  ...
  const Step_ReferralReceived = await page
    .locator('td:nth-child(1) > div > span > span')
    .first()
    .textContent();
  const Step_TitleOrder = await page
    .locator('td:nth-child(1) > div > span > span')
    .nth(1)
    .textContent();
  ...
  const Step_FHALetter = await page
    .locator('td:nth-child(1) > div > span > span')
    .nth(2)
    .textContent();
  ...
  const Step_Complaint = await page
    .locator('td:nth-child(1) > div > span > span')
    .nth(3)
    .textContent();
  ...
  const Step_Judgement = await page
    .locator('td:nth-child(1) > div > span > span')
    .nth(5)
    .textContent();
  ...
  const Step_BankruptcySearch = await page
    .locator('td:nth-child(1) > div > span > span')
    .nth(10)
    .textContent();
  ...
  //Military Search
  const Step_MilitarySearch = await page
    .locator('td:nth-child(1) > div > span > span')
    .nth(11)
    .textContent();
  ...
  //Sale Held
  const Step_SaleHeld = await page
    .locator('td:nth-child(1) > div > span > span')
    .nth(13)
    .textContent();
